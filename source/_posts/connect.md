...
![url的各种格式](/images/storage/url.png)
...
![URL解析](/images/storage/urlany.png)
...
HTTP协议定义了客户端和服务器之间交互的消息内容和步骤,请求中包含了**对什么**和**做什么**两个部分;
...
![doWhat](/images/storage/dowhat.png)
...
![intnet](/images/storage/intnet.png)
...
![naphthalene](/images/storage/naphthalene.png)
...
![ipyanma](/images/storage/ipyanma.png)
...
![mengbi2](/images/storage/mengbi2.jpg)

等等！我怎么访问DNS域名服务器的？我..我怎么知道它的IP的？？

![mangqu](/images/storage/mangqu.jpeg)
...
![allConnect](/images/storage/allConnect.png)

我们这里不需要知道编程怎么实现，因为不管是哪种编程它们都是在委托操作系统在发送信息，所以基本流程如下图。

![simpleConnect](/images/storage/simpleConnect.png)
...
![netstat](/images/storage/netstat.png)
...
![img](/images/storage/v2-ad2bee0fd2abff4bf5807ca93d93cbd6_hd.jpg)
...
![img](/images/storage/v2-72754ddc9c8133906ade003ad4a346d5_hd.jpg)
...
![img](/images/storage/v2-7060962aca6abdc95435330415f968fa_hd.jpg)



具体的数据我们用Wireshark来表抓取一下，如图（蓝色部分为IP数据包）：

![img](/images/storage/v2-489d57b43d9b4c6d2535eeeb60cc7f3f_hd.jpg)
...
![img](/images/storage/v2-8caac8f1477e7e0848743f8a9c1d91ba_hd.jpg)
...
![img](/images/storage/v2-ae1b0c298e03963eab3fc23847a6ef20_hd.jpg)
...
![img](/images/storage/v2-4d7cd156319c914e115b19ee15e70063_hd.jpg)
...
![img](/images/storage/v2-b93fef4ca387c4aa50071dad72fc2085_hd.jpg)
...
![img](/images/storage/v2-325456c5c7054ee6b29795a684cbbffb_hd.jpg)
...
![img](/images/storage/v2-6704e393bd622132d3dac3773412ec26_hd.jpg)
...
![img](/images/storage/v2-fddf614d20e94c08a02861297fb95a99_hd.jpg)
...
![img](/images/storage/v2-1ede5aa9c734a98c0d9c259cd92308fe_hd.jpg)
...
**我严重怀疑你在拖文章长度**
 ...
 ![尴尬表情包](/images/storage/ganga.jpeg) 
